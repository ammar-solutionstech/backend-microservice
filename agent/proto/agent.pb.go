...
const file_agent_proto_agent_proto_rawDesc = "" +
	"\n" +
	"\x17agent/proto/agent.proto\x12\x05agent\"\xc4\x03\n" +
	...
	"\x0fGetPluginStatus\x12\x1a.agent.PluginStatusRequest\x1a\x1b.agent.PluginStatusResponseB\x15Z\x13backend/agent/protob\x06proto3"
