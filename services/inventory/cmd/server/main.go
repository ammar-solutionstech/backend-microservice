...
import (
	...
	"backend/services/inventory/internal/middleware"
	"backend/services/inventory/internal/routes"
	"backend/services/inventory/internal/utils"
)
...
func startGRPCServer(cfg *config.Config) {
	...
	// inventorypb.RegisterInventoryServiceServer(s, services.NewInventoryGRPCServer(...))
